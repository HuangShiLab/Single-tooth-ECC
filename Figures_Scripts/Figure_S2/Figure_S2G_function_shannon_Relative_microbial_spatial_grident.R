...
options(scipen = 4)
data_file="../../data/637/function/KO/637_function_kos_abd.biom"
...
plot1 <- r$plot1 
ggsave(filename=paste(outpath, "/FigS2_637_function_relative_microbial_Gradient.pdf", sep=""), plot=plot1, width=4, height=4)
plot2 <- r$plot2
ggsave(filename=paste(outpath, "/FigS2_637_function_relative_microbial_Gradient2.pdf", sep=""), plot=plot2, width=4, height=4)
plot3 <- r$plot3
ggsave(filename=paste(outpath, "/FigS2_637_function_relative_microbial_Gradient_HostGroup.pdf", sep=""), plot=plot3, width=4, height=4)


metadata_file="../../data/1867/function/1867_function_metadata.tsv"
options(scipen = 4)
data_file="../../data/1867/function/KO/1867_function_kos_abd.biom"
df <- read_biom(data_file)
df <- as.data.frame(t(as.matrix(biom_data(df))))
#df<-read.table(data_file, header=T, row.names=1, quote="", comment.char = "")
metadata<-read.table(metadata_file,header=T,sep="\t",row.names=1, quote="", comment.char="")
...
r <- relative_microbial_Gradient_boxplot(df, metadata)
plot1 <- r$plot1
ggsave(filename=paste(outpath, "/FigS2_1867_function_relative_microbial_Gradient.pdf", sep=""), plot=plot1, width=5, height=4)
plot2 <- r$plot2
ggsave(filename=paste(outpath, "/FigS2_1867_function_relative_microbial_Gradient2.pdf", sep=""), plot=plot2, width=7, height=4)
plot3 <- r$plot3
ggsave(filename=paste(outpath, "/FigS2_1867_function_relative_microbial_Gradient_HostGroup.pdf", sep=""), plot=plot3, width=4, height=4)
