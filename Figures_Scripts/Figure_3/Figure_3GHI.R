...
p.adj.method="BH"
h=10
outpath <- paste("../../Results/Figure_3/", sep="")
...
p
ggsave(filename=paste(outpath,"Figure_3G_Pred_in_",c_category,".boxplot.pdf",sep=""),plot=p, width=3, height=4)
...
ggsave(filename=paste0(outpath, "/Figure_3H_function_HHCC_RF_pred_summ_ROC.pdf"), plot=plot, width=3.5, height=3.5)
...
ggsave(filename=paste0(outpath, "/Figure_3I_function_HHRH_RF_pred_summ_ROC.pdf"), plot=plot, width=3.5, height=3.5)
