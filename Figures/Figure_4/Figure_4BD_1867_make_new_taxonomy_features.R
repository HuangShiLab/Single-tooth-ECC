...
taxonomy_dist <- read.table("../../Results/Dist_matrix/1867_taxonomic_phylo_rPCA/1867_taxonomic_phylo_rpca_dist.txt",
...
p <- ggplot(df1, aes(x = Future_Status_Tooth, y = value, color = Future_Status_Tooth)) + 
...
p
ggsave(filename= paste0(outdir, "/Figure_4B_1867_all_taxonomy_dist_features1.pdf"),plot=p, width=7, height=3)
...
p
ggsave(filename= paste0(outdir, "/Figure_4D_1867_all_taxonomy_dist_features2.pdf"),plot=p, width=7, height=7)
