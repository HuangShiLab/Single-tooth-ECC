...
p_AUROC
ggsave(filename=paste(outpath,"Figure_5D_AUROC_cross_appl_matrix_",c_category, "_among_", s_category,".heatmap.pdf",sep=""),plot=p_AUROC, width=6, height=4.6)
...
p
ggsave(filename=paste(outpath,"Figure_5E_Pred_in_",c_category, "_among_", s_category,".facets.boxplot.pdf",sep=""),plot=p, width=10, height=4)
...
ggsave(filename=paste0(outpath, "Figure_5F_HHRH_AUROC_by_position.heatmap.pdf"),plot=plot, width=12, height=2)
