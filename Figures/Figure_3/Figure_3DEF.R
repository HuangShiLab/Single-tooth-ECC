...
p
ggsave(filename=paste(outpath,"Figure_3D_Pred_in_",c_category,".boxplot.pdf",sep=""),plot=p, width=3, height=4)
...
ggsave(filename=paste0(outpath, "/Figure_3E_taxonomy_HHCC_RF_pred_summ_ROC.pdf"), plot=plot, width=3.5, height=3.5)
...
ggsave(filename=paste0(outpath, "/Figure_3F_taxonomy_HHRH_RF_pred_summ_ROC.pdf"), plot=plot, width=3.5, height=3.5)
