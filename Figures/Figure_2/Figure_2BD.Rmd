...
plot
ggsave(filename=paste(outdir, "/Fig2A_1867_taxonomic_phylo_rpca_PC1.pdf", sep=""), plot=plot, width=10, height=3.5)
```
...
plot <- pc1_position_group_boxplot(pcs, metadata, mapping)
plot
ggsave(filename=paste(outdir, "/Fig2C_1867_functional_rpca_PC1.pdf", sep=""), plot=plot, width=10, height=3.5)
```